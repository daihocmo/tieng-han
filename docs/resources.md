...
- [10k+ Frequency Deck](https://drive.google.com/file/d/1zByzGqoDae-r7Z4LgUnla6sGBDh0TgWJ/view): Bộ từ vựng xếp theo độ phổ biến.
...
## CÔNG CỤ HỖ TRỢ ĐỌC & ĐÁNH GIÁ CẤP ĐỘ

- [Vocab Tracker](https://www.vocabtracker.com/getpage/Auth/Login) & [Korean Reader](https://koreanreader.com/) - Các trang web hỗ trợ đọc hiểu văn bản tiếng Hàn (lấy cảm hứng từ LingQ), tích hợp tra từ trực tiếp. *Lưu ý nhỏ: Công cụ chưa tối ưu tốt để hiển thị dạng từ gốc đối với những từ đã chia đuôi ngữ pháp phức tạp hoặc đính kèm nhiều hậu tố.*
- [My Korean Ramblings Blog](https://www.mykoreanramblings.com/2014/04/10/thoughts-on-make-your-own-reader/) - Bài blog chia sẻ mẹo hữu ích để bạn tự biên soạn tài liệu đọc hiểu (custom graded reader) bám sát theo trình độ cá nhân.
- [Learn Natively](https://learnnatively.com/) - Hệ thống trang web đánh giá và phân loại cấp độ (từ dễ đến khó) cho các tài liệu sách truyện, video tiếng Hàn dựa trên phản hồi thực tế từ cộng đồng người học toàn cầu.
- [Lingotrack](https://lingotrack.com/search?langs=Korean) - Nền tảng tìm kiếm, theo dõi tiến độ đọc và lưu trữ các tài liệu Comprehensible Input tiếng Hàn đa dạng.
- [랑이언ni의 잘자요 동화 (Naver Audioclip)](https://audioclip.naver.com/channels/350) - Kênh podcast truyện cổ tích đêm muộn dành cho trẻ em, có thể dùng làm tài liệu kết hợp vừa nghe vừa dò theo truyện chữ thiếu nhi để đối chiếu phát âm.