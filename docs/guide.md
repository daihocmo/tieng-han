...
3. Diễn tả hành động của từ — hoặc — chỉ vào đồ vật khi nói từ đó.
   Ví dụ: nếu từ vựng là 의자, hãy chỉ vào cái ghế và nói “의자!” nhiều lần. Có thể bạn sẽ thấy hơi ngại, nhưng nó giúp rất nhiều.
4. Với động từ, dùng [trang web này](https://www.verbix.com/languages/korean) để xem cách chia động từ. Hầu hết động từ khá đơn giản (như -하다), nhưng một số sẽ khó hơn. Hãy học cả ba thì ngay từ đầu (bạn sẽ thấy thì quá khứ thường dùng đuôi như -었어요, còn thì tương lai thường dùng -(ㄹ) 거예요 hoặc 겠어요).
5. Để hỗ trợ phát âm, mình dùng [Forvo](https://forvo.com/languages/ko/)
6. Tìm các câu ví dụ có chứa từ vựng để xem cách dùng trong ngữ cảnh. Bạn có thể sử dụng [Naver](https://ko.dict.naver.com/#/main).
...
Xem nội dung có phụ đề bằng ngôn ngữ mục tiêu (Target Language – TL).
Giờ đây bạn đã chính thức sẵn sàng tiếp cận nội dung có phụ đề tiếng Hàn. Đúng là bạn sẽ thấy bối rối. Đúng là bạn sẽ không hiểu hết mọi thứ. Nhưng bạn sẽ học được rất nhiều từ mới, cụm từ mới, cách nói, thói quen ngôn ngữ… vì bạn không còn phụ thuộc vào phụ đề tiếng Anh nữa.
...
_Học một ngôn ngữ giống như ghép một bức tranh 10.000 mảnh. Mỗi quy tắc ngữ pháp và mỗi từ vựng bạn học là một mảnh ghép. Càng ghép được nhiều mảnh, bức tranh càng rõ nét và bạn càng hiểu nhiều hơn._ 영원히 화이팅!
