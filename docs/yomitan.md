...
Yomitan là một extension (tiện ích mở rộng) trên trình duyệt (Chrome, Chromium-based hoặc Firefox) cho phép bạn tra cứu các từ Tiếng Hàn cả nghĩa lẫn cách đọc trên trang web một cách dễ dàng.
...
*nhớ phải thay đổi ngôn ngữ về Tiếng Hàn (Korean) nhé.*
...
Bạn có thể xem danh sách [từ điển Tiếng Hàn cho Yomitan](https://github.com/MarvNC/yomitan-dictionaries?tab=readme-ov-file#korean). Dưới đây là một số từ điển mà mình tìm được (Bấm vào tên từ điển để tải luôn nhé):

### Từ điển song ngữ (Hàn - Việt)

- [KO-VI.KRDICT.zip](https://github.com/Lyroxide/yomitan-ko-dic/releases/download/1.0.0/KO-VI.KRDICT.zip) - Có câu ví dụ.
- [KO-VI.KRDICT.No.Examples.zip](https://github.com/Lyroxide/yomitan-ko-dic/releases/download/1.0.0/KO-VI.KRDICT.No.Examples.zip) - Không có câu ví dụ.
- [Từ điển Hàn - Việt (OVDP)](https://github.com/catusf/tudien/releases/download/v4.4/star_hanviet.yomitan.zip)
...
Trên thanh công cụ trình duyệt, nếu bạn chọn biểu tượng Yomitan, sau đó chọn biểu tượng ![search icon](img/yomitan-search.png) hoặc dùng tổ hợp phím tắt `Alt+ Insert`, bạn có thể truy cập vào "Yomitan Search" - bạn có thể sử dụng Yomitan như một từ điển Tiếng Hàn riêng (Hoàn toàn Offline).
...
**Frequency - Korean CC100** - Danh sách tần suất các từ xuất hiện trên Internet của Hàn
